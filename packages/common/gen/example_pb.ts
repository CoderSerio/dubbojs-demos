...
/**
 * @generated from message apache.dubbo.demo.helloworld.SayRequest
 */
export class SayRequest extends Message<SayRequest> {
  ...
  static readonly typeName = "apache.dubbo.demo.helloworld.SayRequest";
...
/**
 * @generated from message apache.dubbo.demo.helloworld.SayResponse
 */
export class SayResponse extends Message<SayResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "apache.dubbo.demo.helloworld.SayResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
